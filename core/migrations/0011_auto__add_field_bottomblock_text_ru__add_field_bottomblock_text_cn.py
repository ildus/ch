...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BottomBlock.text_ru'
        db.add_column('core_bottomblock', 'text_ru', self.gf('django.db.models.fields.TextField')(default='asdf'), keep_default=False)

        # Adding field 'BottomBlock.text_cn'
        db.add_column('core_bottomblock', 'text_cn', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BottomBlock.text_ru'
        db.delete_column('core_bottomblock', 'text_ru')

        # Deleting field 'BottomBlock.text_cn'
        db.delete_column('core_bottomblock', 'text_cn')
    ...
    models = {
        'core.bottomblock': {
            ...
            'text_cn': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'text_ru': ('django.db.models.fields.TextField', [], {})
        },
        'core.newsitem': {
            ...
            'right_ru': ('django.db.models.fields.TextField', [], {}),
