...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BottomBlock.second'
        db.delete_column('core_bottomblock', 'second')

        # Deleting field 'BottomBlock.third'
        db.delete_column('core_bottomblock', 'third')

        # Deleting field 'BottomBlock.first'
        db.delete_column('core_bottomblock', 'first')


    def backwards(self, orm):
        
        # We cannot add back in field 'BottomBlock.second'
        raise RuntimeError(
            "Cannot reverse this migration. 'BottomBlock.second' and its values cannot be restored.")

        # We cannot add back in field 'BottomBlock.third'
        raise RuntimeError(
            "Cannot reverse this migration. 'BottomBlock.third' and its values cannot be restored.")

        # We cannot add back in field 'BottomBlock.first'
        raise RuntimeError(
            "Cannot reverse this migration. 'BottomBlock.first' and its values cannot be restored.")
