...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BottomBlock.text'
        db.add_column('core_bottomblock', 'text', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BottomBlock.text'
        db.delete_column('core_bottomblock', 'text')
