...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsItem.anonce'
        db.add_column('core_newsitem', 'anonce', self.gf('django.db.models.fields.TextField')(default='', max_length=2000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsItem.anonce'
        db.delete_column('core_newsitem', 'anonce')
